...
import imgLogo from '../assets/111d153f-f989-4481-b40a-b45a6a6a4dd6-removebg-preview.png'
...
const Nabar = () => {
  let [showbar, setsowbar] = useState(false)
  let heandelshowbar = () => {
    setsowbar(!showbar)
  }
  return (
    ...
    <div>
      ...
      <Continar>
        <header className="shadow-md tracking-wide relative w-full z-50">

          <div className=" flex justify-between px-3 items-center px-0 py-3 bg-gray-200 min-h-[65px]">
            ...
            <div className="flex gap-1 items-center">
              ...
              <div className="">
                ...
                <h3 className='font-bold text-[18px]'> Bangladesh</h3>
              </div>
            </div>
            ...
            >
              <div className='flex items-center' >
                <input className='border-gray-400 border px-2 py-2 w-[500px] text-xl font-medium  rounded-l-[15px] outline-none focus:shadow-[0_0_3px] focus:shadow-cyan-400  focus:border focus:border-cyan-400  ' type="search" placeholder='search...' />

                <button className=' px-2 py-3 bg-blue-500 rounded-r '><IoIosSearch className=' text-2xl text-white ' /></button>
              </div>
            </div>
            <div className=''>
              <button className=' hover:border hover:border-white  p-2 rounded-[5px] hover:shadow-white  shadow'>
                <p className='text-gray-800 text-[15px]'> Hello, sign in</p>
                <h4 className='text-[20px] font-bold'>Account</h4>
              </button>
            ...
            <div className="">
              <button className='hover:border hover:border-white  p-2 rounded-[5px] hover:shadow-white  shadow'>
                <p className='text-gray-800 text-[15px]'> Returns</p>
                <h4 className='text-[20px] font-bold'>& Odrders</h4>
              </button>
            </div>
            <div className="mr-2">
              <button className='flex gap-1 items-center hover:border hover:border-white  p-4 rounded-[5px] hover:shadow-white  shadow '>
                <FaShoppingCart className='text-3xl' />
                <h4 className='text-[18px] font-bold'>Cart</h4>
              </button>
            </div>

          </div>
          <section className="py-2 flex items-center gap-5 bg-[#007bff] text-white  px-10">

            <div className=' relative ' >
              <button onClick={heandelshowbar} className='flex font-bold items-center gap-1 text-[18px]  hover:border hover:border-white  p-1 rounded-[5px] hover:shadow-white  shadow '><GiHamburgerMenu />All</button>
              {
                showbar ?
                  <nav className="bg-[#f7f7f8] top-11 left-[-40px] w-[400px] py-6 px-4 absolute">
                    <div className="relative">
                      <div className="w-[150px] ">
                        <img src="src/assets/111d153f-f989-4481-b40a-b45a6a6a4dd6-removebg-preview.png" alt="" />
                        <MdCancel onClick={() => setsowbar(false)} className='text-gray-400 text-[45px] absolute cursor-pointer top-0
                   right-0'/>
                      </div>

                      <div className="absolute -right-6 top-1 h-6 w-6 p-[6px] cursor-pointer  flex items-center justify-center rounded-full">
                        <svg
            ...
            <ul className='flex gap-5'>
              <li className=' hover:border hover:border-white  p-2 rounded-[5px] hover:shadow-white  shadow'>
